  ...
  const silFeatures = [
    {
      ...
      desc: "Compassionate, structured guidance focused on cultivating healthy personal habits, personal care, and balanced morning-to-night schedules.",
    },
    {
      icon: "🍳",
      title: "Life Skills Development",
      desc: "Hands-on, progressive skill building covering nutritious meal preparation, personal grocery shopping, budgeting, and everyday digital literacy.",
    },
    {
      icon: "🧹",
      title: "Household Management",
      desc: "Empowering participants to confidently manage domestic spaces through collaborative home upkeep, laundry routines, and property safety.",
    },
    {
      icon: "🗺️",
      title: "Personal Independence Training",
      desc: "Tailored roadmaps that develop confidence outside the home, emphasizing safe public transport usage, spatial navigation, and neighborhood familiarity.",
    },
    {
      icon: "🛡️",
      title: "24/7 On-Call Support Track",
      desc: "Complete operational stability featuring round-the-clock specialized overnight assistance, respite coverage, and rapid crisis response.",
    },
    {
      icon: "✨",
      title: "Social Inclusion Pathways",
      desc: "Eliminating social boundaries by connecting residents directly with local clubs, public volunteer options, and creative weekend programs.",
    },
  ];
  ...
  return (
    <main className="bg-white selection:bg-[#3e5068] selection:text-white antialiased min-h-screen flex flex-col justify-between">
      ...
      <section className="relative pt-44 pb-20 overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white">
        {/* Cinematic Backdrop Lighting Accents */}
            ...
            <div className="space-y-6 max-w-2xl">
              ...
              <FadeUp delay={0.2}>
                <p className="text-slate-500 text-base md:text-lg font-medium leading-relaxed max-w-xl">
                  Helping participants develop foundational independence and core life skills through deeply tailored individual support frameworks, configured inside exceptionally safe, welcoming living environments.
                </p>
              </FadeUp>
            ...
            <FadeUp delay={0.4}>
              <div className="relative w-full aspect-square sm:aspect-[4/3] lg:aspect-square rounded-[3.5rem] sm:rounded-[4.5rem] overflow-hidden border border-slate-100 shadow-[0_30px_70px_rgba(62,80,104,0.15)] group">
                <img
                  ...
                  alt="Modern architectural, premium shared residential independent living space"
                ...
                <div className="absolute bottom-8 left-8 bg-white/95 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl p-5 sm:p-6 max-w-[220px] sm:max-w-xs transition-transform duration-500 group-hover:translate-y-[-5px]">
                  <h3 className="font-black text-2xl sm:text-3xl text-[#3e5068] leading-tight">
                    Secure & Nurturing
                  </h3>
                  <p className="text-slate-400 font-medium text-xs mt-1">
                    24/7 Professional Structural Safety Plans
                  </p>
                </div>
              </div>
            </FadeUp>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <FadeUp>
            <div className="text-center mb-20 space-y-3">
              <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#3e5068]">Functional Tracks</p>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
                Core Independence Modules
              </h2>
              <p className="text-slate-400 font-medium text-base max-w-2xl mx-auto leading-relaxed">
                Our specialized SIL services are mapped completely around personal routine variables to ensure transition steps feel continuous, dignified, and metrics-supported.
              </p>
            </div>
          </FadeUp>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {silFeatures.map((feature, index) => (
              <FadeUp key={index} delay={index * 0.05}>
                <div className="group h-full bg-slate-50/50 hover:bg-white p-8 md:p-10 rounded-[2.5rem] border border-slate-100 hover:shadow-[0_25px_60px_rgba(62,80,104,0.05)] transition-all duration-500 flex flex-col justify-between">
                  <div>
                    {/* Icon container with brand color toggle behavior on hover */}
        ...
        <div className="max-w-7xl mx-auto bg-gradient-to-tr from-slate-900 via-[#253243] to-slate-900 rounded-[3.5rem] sm:rounded-[4.5rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-[0_40px_90px_rgba(15,23,42,0.15)]">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6 sm:space-y-8">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter leading-none">
              Looking for a genuinely custom <br className="hidden sm:inline" /> SIL Accommodation Balance?
            </h2>

            <p className="text-slate-400 font-medium text-sm md:text-base max-w-xl mx-auto leading-relaxed">
              Connect directly with our accommodation alignment team today to systematically analyze vacancies, coordinate house matching parameters, and match your active NDIS plans with long-term care stability.
            </p>
